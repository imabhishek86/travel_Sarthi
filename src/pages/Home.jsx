...
const Home = () => {
  ...
  return (
    <div className="w-full bg-white min-h-screen pb-20 pt-24">
      
      {/* Categories Header - Clean without icons */}
      <div className="w-full border-b border-gray-200 bg-white sticky top-20 z-30 pt-4 pb-4 shadow-sm">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        {loading ? (
          ...
          <div className="text-center py-32 bg-gray-50 rounded-3xl border border-gray-100 mt-4">
          ...
          <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-12">
            {displayHotels.map((hotel) => (
              ...
              >
                <div className="relative aspect-square w-full rounded-2xl overflow-hidden mb-3 bg-gray-100 border border-gray-100 shadow-sm group-hover:shadow-xl transition-all duration-500">
                  <img 
                ...
                <div className="flex justify-between items-start pt-1">
                  <div className="flex-1 pr-2">
                    ...
                    <p className="text-sm text-gray-500 mt-0.5 truncate font-medium">{hotel.name}</p>
                    <p className="text-sm text-gray-400 mt-0.5 font-medium">Added recently</p>
        ...
        {!loading && hotels.length > 0 && (
          <div className="mt-20 mb-12 text-center">
            <p className="text-lg font-bold text-gray-900 mb-4">Continue exploring amazing stays</p>
            <button className="px-8 py-3.5 bg-gray-900 text-white rounded-xl font-bold hover:bg-black transition-colors shadow-lg">
              Show more
            </button>
          </div>
        )}
